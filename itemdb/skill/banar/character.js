  ...
  masteries: {
    blade: {
      skills: [
        ...
        // Column 2 branches
        { id: "b2_3", col: 2, row: 3, max: 0, val: 0, req: ["b1_2"], icon: "ICON_SKILL_AO_BIZSAI.bmp", skillDataId: 3011 },
        ...
        { id: "b3_2", col: 3, row: 2, max: 0, val: 0, req: [], icon: "ICON_SKILL_AV_UTTHA.bmp", skillDataId: 3059 },
        ...
        { id: "b4_4", col: 4, row: 4, max: 0, val: 0, req: [], icon: "ICON_SKILL_P_PRAHASTAROKA.bmp", skillDataId: 3097 },
        { id: "b4_5", col: 4, row: 5, max: 0, val: 0, req: ["b4_4"], icon: "ICON_SKILL_P_PRATYAYA.bmp", skillDataId: 3060 }
      ]
    },
    archery: {
      skills: [
        ...
        // Column 2
        { id: "b2_1", col: 2, row: 1, max: 0, val: 0, req: [], icon: "Icon_skill_av_savitriforce01.bmp", skillDataId: 3042 },
    ...
    support: {
      skills: [
        ...
        { id: "b1_2", col: 1, row: 2, max: 0, val: 0, req: ["root"], icon: "ICON_SKILL_AO_BUKAMPA.bmp", skillDataId: 3025 },
        { id: "b1_3", col: 1, row: 3, max: 0, val: 0, req: ["b1_2"], icon: "ICON_SKILL_AV_AKHILA_ruj.bmp", skillDataId: 3014 },
        // Column 2 branches
    ...
    amara: {
      skills: [
        // Main branch (column 1)
        { id: "root", col: 1, row: 1, max: 0, val: 0, req: [], icon: "ICON_SKILL_100lv_06.bmp", skillDataId: 3019 }
