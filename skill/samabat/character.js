  ...
  masteries: {
    blade: {
      skills: [
        ...
        // Column 2 branches
        { id: "b2_1", col: 2, row: 1, max: 0, val: 0, req: [], icon: "ICON_SKILL_AO_MANTRA01.bmp", skillDataId: 3301 },
        { id: "b2_2", col: 2, row: 2, max: 0, val: 0, req: ["b2_1"], icon: "ICON_SKILL_AO_CHANDRAROCA.bmp", skillDataId: 3321 },
        { id: "b2_3", col: 2, row: 3, max: 0, val: 0, req: ["b2_2"], icon: "ICON_SKILL_P_Ramhas.bmp", skillDataId: 3303 },
        { id: "b2_4", col: 2, row: 4, max: 0, val: 0, req: ["b2_3"], icon: "ICON_SKILL_AO_CHANDRAFORCE.bmp", skillDataId: 3326 },
        { id: "b2_5", col: 2, row: 5, max: 0, val: 0, req: ["b2_4"], icon: "ICON_SKILL_AO_DESTI.bmp", skillDataId: 3325 },
        
        // Column 3 branch
        { id: "b3_1", col: 3, row: 1, max: 0, val: 0, req: [], icon: "ICON_SKILL_AGNIARROW.bmp", skillDataId: 3315 },
        { id: "b3_2", col: 3, row: 2, max: 0, val: 0, req: ["b3_1"], icon: "ICON_SKILL_AV_AGNIGUNA.bmp", skillDataId: 3316 },
        { id: "b3_3", col: 3, row: 3, max: 0, val: 0, req: ["b3_2"], icon: "ICON_SKILL_AO_AGNI.bmp", skillDataId: 3327 },
        { id: "b3_4", col: 3, row: 4, max: 0, val: 0, req: ["b3_3"], icon: "ICON_SKILL_AO_MAHOLKA.bmp", skillDataId: 3324 },
        { id: "b3_5", col: 3, row: 5, max: 0, val: 0, req: ["b3_4"], icon: "ICON_SKILL_HOLDFIRE.bmp", skillDataId: 3306 },
        { id: "b3_6", col: 3, row: 6, max: 0, val: 0, req: ["b3_5"], icon:"ICON_SKILL_AO_AGNIBLAZE.bmp", skillDataId : 3341 }
    ...
    archery: {
      skills: [
        // Main branch (column 1)
        { id: "root", col: 2, row: 1, max: 0, val: 0, req: [], icon: "ICON_SKILL_AO_HIMA.bmp", skillDataId: 3304 },
        { id: "b2_2", col: 2, row: 2, max: 0, val: 0, req: ["root"], icon: "ICON_SKILL_AV_INCRESESPEED_YAKSA.bmp", skillDataId: 3317 },
        { id: "b2_3", col: 2, row: 3, max: 0, val: 0, req: ["b2_2"], icon: "ICON_SKILL_AO_HIMACHACRA.bmp", skillDataId: 3322 },
        { id: "b2_4", col: 2, row: 4, max: 0, val: 0, req: ["b2_3"], icon: "ICON_SKILL_AO_HIMARESMAN.bmp", skillDataId: 3343 },

        // Row 3 sub-branches (b1_3 → b2_3 → b3_3)
        { id: "b3_2", col: 3, row: 2, max: 0, val: 0, req: [], icon: "ICON_SKILL_AO_RU.bmp", skillDataId: 3305 },
        { id: "b3_3", col: 3, row: 3, max: 0, val: 0, req: ["b3_2"], icon: "ICON_SKILL_AV_RUGUNA.bmp", skillDataId: 3318 },
        { id: "b3_4", col: 3, row: 4, max: 0, val: 0, req: ["b3_3"], icon: "ICON_SKILL_AO_RAUTI.bmp", skillDataId: 3323 },
        { id: "b3_5", col: 3, row: 5, max: 0, val: 0, req: ["b3_4"], icon: "ICON_SKILL_P_LAKSROKA02.bmp", skillDataId: 3361 }
      ]
    },
    support: {
      skills: [
        ...
        { id: "b1_3", col: 1, row: 3, max: 0, val: 0, req: [], icon: "ICON_SKILL_AV_VISHUNUZROCA.bmp", skillDataId: 3330 },
        { id: "b1_4", col: 1, row: 4, max: 0, val: 0, req: ["b1_3"], icon: "ICON_SKILL_AO_VARGA.bmp", skillDataId: 3357 },
        { id: "b1_5", col: 1, row: 5, max: 0, val: 0, req: ["b1_4"], icon: "ICON_SKILL_AO_pravara.bmp", skillDataId: 3337 },
        ...
        { id: "b2_3", col: 2, row: 3, max: 0, val: 0, req: ["b2_2"], icon: "ICON_SKILL_AV_SAATA.bmp", skillDataId: 3320 },
        { id: "b2_4", col: 2, row: 4, max: 0, val: 0, req: ["b2_3"], icon: "ICON_SKILL_AO_ZAMA02.bmp", skillDataId: 3328 },
        
        // Column 3 branch
        { id: "b3_1", col: 3, row: 1, max: 0, val: 0, req: [], icon: "ICON_SKILL_AO_MANTRAYPATTRA.bmp", skillDataId: 3332 },
        { id: "b3_2", col: 3, row: 2, max: 0, val: 0, req: ["b3_1"], icon: "ICON_SKILL_AO_MANTRAYKAMSYA.bmp", skillDataId: 3331 },
        { id: "b3_3", col: 3, row: 3, max: 0, val: 0, req: ["b3_2"], icon: "ICON_SKILL_AO_DADATI.bmp", skillDataId: 3359 },

        // Column 4 - Independent main branch (no sub branches, no connectors)
        { id: "b4_1", col: 4, row: 1, max: 0, val: 0, req: [], icon: "ICON_SKILL_AO_rogazama.bmp", skillDataId: 3336 },
        { id: "b4_2", col: 4, row: 2, max: 0, val: 0, req: [], icon: "ICON_SKILL_P_ABHIDHA.bmp", skillDataId: 3360 },
        { id: "b4_3", col: 4, row: 3, max: 0, val: 0, req: [], icon: "ICON_SKILL_AO_SPTA02.bmp", skillDataId: 3309 },
        { id: "b4_4", col: 4, row: 4, max: 0, val: 0, req: ["b4_3"], icon: "ICON_SKILL_AO_SPTARESMAN02.bmp", skillDataId: 3329 }
      ]
    },
    amara: {
      skills: [
        // Main branch (column 1)
        { id: "root", col: 1, row: 1, max: 0, val: 0, req: [], icon: "ICON_SKILL_100lv_08.bmp", skillDataId: 3338 }
